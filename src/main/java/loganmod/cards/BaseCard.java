package loganmod.cards;

import basemod.BaseMod;
import basemod.abstracts.CustomCard;
import basemod.abstracts.DynamicVariable;
import loganmod.LoganMod;
import loganmod.util.CardStats;
import loganmod.util.TriFunction;
...
import static loganmod.util.GeneralUtils.removePrefix;
import static loganmod.util.TextureLoader.getCardTextureString;
        ...
        if (!upgraded) {
            ...
            if (this.upgradesDescription) {
                if (cardStrings.UPGRADE_DESCRIPTION == null) {
                    LoganMod.logger.error("Card " + cardID + " upgrades description and has null upgrade description.");
                } else {
